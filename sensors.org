...
*** TODO Capacitance-based Devices
- A “Mousepad” or “touchpad” is now ubiquitous, reliable and stable
...
Many geometries including some with “finger-like” curvatures
μ 0 = 4π 10 -7 henry/m, ε 0 = μ 0 /c 2 = 8.85 10 -12 farad/m

*** TODO Magnetic and Inductive Effects
- Many prototypes, multi-generation developments or applications
...
- Magnetic effects, e.g., magneto-resistance plausible
    – recent development of “giant” and “colossal” magneto-resistance materials may hold some promise
- Some slip-sensing potential with dipoles oriented within surface
...
- Due to leakage, effect is transient
    – to stabilize, leakage is intentionally increased, making device respond effectively to dP/dt
...
- Plastics (e.g., polyvinylidene difluoride PDVF aka PVF 2 )
    – (apparently) enormous quantities are used in
submarine sonar transducers

*** Example: Current-to-Voltage Conversion
- Simple: \(I = V_{measured} / R_{known}\)
- Better: Use an "op amp"
...
+ "Flash converter" is the fastest, has the lowest resolution and the highest cost
