...
*** Analog front end
  ...
  {{{revealimg("figures/analogfront.meta","Block Diagram of a Typical Imaging Application","20vh",nil,'none)}}}
...
*** Color is an artifact of human perception
  ...
  {{{revealimg("figures/spectrum.meta",t,"50vh")}}}
...
*** Spectral Sensitivity Function of Human Eye
  ...
  {{{revealimg("figures/humanssf.meta",t,"50vh")}}}
...
*** Many different spectral sensitivity functions
  {{{revealimg("figures/cameracomparison.meta","Different Camera Sensor Produces Different Colors","50vh",nil,'none)}}}
...
*** Color Gamuts
  {{{revealimg("figures/colorgamut.meta",t,"50vh")}}}
...
\[ d = \frac{1}{2} \frac{q_1}{q_1+q_2} ct \] 
