...
*** Supercapacitors
- Supercapacitors (or supercaps) store energy at significantly higher volumes than typical capacitors {{{reveallicense("./figures/ultracapacitorbus.meta","20vh",nil,'none)}}}
