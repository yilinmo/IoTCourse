...
*** LTE Resource Block
  {{{revealimg("./figures/lteresourceblock.meta","LTE Resource Block","40vh",nil,'none)}}}

*** LTE Resource Block
- Each LTE frame is 20MHz and 10ms
...
- 7 OFDM symbols can be transmitted in 1 slot (\(0.5 ms \times 15kHz\))
- 1 resource block contains 84 OFDM symbols
...
| IEEE 802.11   | CSMA/CA                |
| Bluetooth     | CSMA/CA or TDMA + FHSS |
| IEEE 802.15.4 | CSMA/CA and TDMA       |
