(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("da486d8f-8105-42e2-90b7-9aa8acad9347");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'da486d8f-8105-42e2-90b7-9aa8acad9347' but no matching script tag was found.")
        }
