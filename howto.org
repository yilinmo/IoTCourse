...
** What’s This?
   ...
   - Emacs-reveal is [[https://fsfe.org/about/basics/freesoftware.en.html][free software]]
     ...
     {{{reveallicense("./img/board.meta","30vh")}}}
     - Benefits
     - For your audience
...
** Figure with Caption and License
   ...
   {{{revealimg("img/decision.meta","To share or not to share","30vh")}}}

*** Meta-Data File for Previous Image

#+INCLUDE: ./img/decision.meta src emacs-lisp
...
** Go for it!
   ...
   {{{revealimg("./img/steps.meta","The road ahead …")}}}
