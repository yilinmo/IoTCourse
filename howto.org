...
*** Initial Consideration
    - ~Emacs-reveal~ can manage bundled software (submodules for Lisp
...
*** Alternative installation
    - You you prefer to manage the submodules of ~emacs-reveal~
      yourself, clone without option ~--recursive~ and set
      ~emacs-reveal-managed-install-p~ to ~nil~ (*before* you
      load/require ~emacs-reveal~ for the first time)
      1. Choose directory and clone
         - =cd ~/.emacs.d/elpa=
