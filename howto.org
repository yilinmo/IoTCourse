...
** Klipse for Code Evaluation
   - Org-Reveal supports [[https://github.com/viebel/klipse][Klipse]]
     - Teach programming
     - Browser-side code evaluation for various programming languages
       - See [[https://github.com/lechten/org-reveal/blob/master/Readme.org][README of Org-Reveal]]
         for supported ones
       - Note that variable ~org-reveal-klipsify-src~ needs to be
         ~non-nil~
   ...
   - Next two slides copied from
     [[https://github.com/lechten/org-reveal/blob/master/Readme.org][README of Org-Reveal]]
     - Code changes in the upper part result in output
