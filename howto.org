...
** Alternatives
   ...
   3. Create presentations in [[https://www.docker.com/][Docker]] container
      {{{reveallicense("./figures/logos/docker-horizontal.meta","10vh")}}}
      - Based on [[https://gitlab.com/oer/docker][Docker image with emacs-reveal]]
   ...
   4. Create and publish presentations with [[https://about.gitlab.com/][GitLab CI/CD]]
