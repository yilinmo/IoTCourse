...
#+DATE: December 2019 (emacs-reveal 5.0.3 and later)
...
*** Alternative installation
    ...
    - Thus, you can also initialize those submodules and adjust your
      ...
      - File ~elisp/publish.el~ of this howto sets the new variable
        ~emacs-reveal-docker-path~ to have ~emacs-reveal.el~ configure
        the ~load-path~
...
,#+SPDX-License-Identifier: CC-BY-SA-4.0
       ...
       - Note that SPDX headers must be prefixed with ~#+~ to
         recognize them as Org mode keywords
