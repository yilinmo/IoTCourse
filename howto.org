...
#+DATE: February 2019 (emacs-reveal 0.9.8 and later)
...
*** Emacs-reveal like a Package?
    ...
    - However, note that ~emacs-reveal~ contains some resources (Org,
      ...
      - To use them, your publish function needs to know their
        location
        - (As in [[https://gitlab.com/oer/emacs-reveal/blob/master/emacs-reveal-publish.el][emacs-reveal-publish.el]]
          used by [[https://gitlab.com/oer/emacs-reveal-howto/blob/master/elisp/publish.el][elisp/publish.el]]
          of this Howto)
        - Relevant customize variables include ~emacs-reveal-dir~ and
...
** Building Presentations in Emacs
   1. Generate HTML presentation for visited
	...
	in default browser
      - For this to work, necessary resources, in particular
...
** Slide with Figure and Audio
   ...
   - This figure is part of a
     [[https://oer.gitlab.io/OS/Operating-Systems-09-Memory-II.html][different presentation]]
...
{{{revealgrid(42,"./figures/devices/computer.grid",60,4,3,"\"ga1 ga2 ga2 ga3\" \"ga1 ga4 ga5 ga6\" \"ga7 ga8 ga9 ga9\"")}}}
      #+END_SRC
      - Arguments explained in [[https://gitlab.com/oer/emacs-reveal/blob/master/org/config.org][emacs-reveal/org/config.org]]
...
** Klipse for Code Evaluation
   ...
   - Org-re-reveal supports [[https://github.com/viebel/klipse][Klipse]]
     ...
     - Browser-side code evaluation for various programming languages
       - Constant ~org-re-reveal-klipse-languages~ contains supported subset
         - {{{klipse-languages}}}
       - Note that variable ~org-re-reveal-klipsify-src~ needs to be
         ~non-nil~
...
#+INCLUDE: "emacs-reveal/org/license-template.org" :minlevel 2
