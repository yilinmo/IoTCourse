...
*** Copy-On-Write Drawing
    ...
    {{{reveallicense("./figures/hail_f0607.pdf.meta","40vh")}}}
...
*** Address Translation Example 
    ...
    {{{reveallicense("./figures/hail_f0612.pdf.meta","40vh")}}}
...
** Comparison 
|                 | Bare Metal    | Tiny OS                 | Free RTOS                | Linux                          |
| Overhead        | None          | Small                   | Small                    | Large                          |
| Scheduler       | Single Thread | Event-Based, FIFO       | Round-Robin, Real-time   | CFS                            |
| Synchornization | None          | Resolved at Compilation | MX, Semaphores           | Multiple Locking Types         |
| Memory          | Static        | Static                  | 5 Dynamic Memory Schemes | Full fledged Memory Management |
