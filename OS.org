...
*** OS Responsibilities
    ...
    :END:
    {{{revealimg("./figures/OS-responsibilities.meta",t,"50vh")}}}
...
** Sample Modern Operating Systems
   ...
   - Different systems for different scenarios
     ...
     - PCs
       - [[https://en.wikipedia.org/wiki/MS-DOS][MS-DOS]],
         [[https://en.wikipedia.org/wiki/GNU%2FLinux_naming_controversy][GNU/Linux]],
         [[https://en.wikipedia.org/wiki/MacOS][MacOS]],
         [[https://www.redox-os.org][Redox]],
         [[https://en.wikipedia.org/wiki/Microsoft_Windows][Windows]]
     - Mobile devices
...
*** How to Talk to OSs
    {{{revealimg("./figures/system-calls.meta",t,"50vh")}}}

*** User Space and Kernel Space
    {{{revealimg("./figures/user-space.meta",t,"50vh")}}}
...
** Learning Objectives
   - Explain thread concept, thread switching, and multitasking
     - Including reasons for threads
       - With learning objectives for [[file:Operating-Systems-Introduction.org::#battlethreads][BattleThreads]],
         rephrased from cite:HRB+03
...
*** Previously on OS …
    #+ATTR_REVEAL: :frag (appear)
    - What is a thread?
      {{{revealimg("./figures/threads.meta",t,"40vh","figure fragment appear")}}}
...
*** Parallelism
	...
	- Recall CS part about [[https://en.wikipedia.org/wiki/Moore%27s_law][Moore’s law]]
...
** Main Reasons
   ...
   - *Resource utilization*
     - Keep most of the hardware resources busy most of the time, e.g.:
       - While one thread is waiting for external event (e.g., disk
         or network I/O), allow other threads to continue
	 - Next slide
...
** Preemptive Multitasking
   ...
   - Additional mechanism: Timer interrupts
	 ...
	 - [[file:Operating-Systems-Scheduling.org][Upcoming presentation]]
...
*** CPU Scheduling
    ...
    {{{revealimg("./figures/scheduling.meta",t,"50vh")}}}
...
** Learning Objectives
   - Recognize and explain race conditions
     - (Playing [[https://deadlockempire.github.io/][Deadlock Empire]] helps)
...
** Locks and Mutexes
   ...
   - Lock = mutex = object with methods
     ...
     - E.g., interface [[https://docs.oracle.com/en/java/javase/12/docs/api/java.base/java/util/concurrent/locks/Lock.html][java.util.concurrent.locks.Lock]] in Java.
...
** Use of Locks/Mutexes
  ...
  - See cite:Hai19 for sample code following POSIX standard
...
** Today’s Core Questions
   - What is virtual memory?
     ...
     - How does the OS keep track for each process what data resides
       where in RAM?
...
*** Retrieval Practice
    - How are
      [[file:Operating-Systems-Introduction.org::#computations-processes-threads][processes and threads]]
      related?
    - Why were threads in
      [[file:Operating-Systems-Introduction.org::#battlethreads][BattleThreads]]
      more successful?
    - What [[file:Operating-Systems-Overview.org::#virtual-address-space][layer of abstraction]]
      do OSs use to manage RAM?
    - What happens when an [[file:Operating-Systems-Interrupts.org::#irq-idea][interrupt]]
      is triggered (e.g., a [[file:Operating-Systems-Interrupts.org::#terminology][page fault]])?

*** Recall: RAM in Hack
    :PROPERTIES:
    :CUSTOM_ID: hack-ram
    :END:
#+REVEAL_HTML: <script data-quiz="quizHackRAM" src="./quizzes/Hack-RAM.js"></script>
...
** Different Learning Styles
   - The bullet point style may be particularly challenging for this
     presentation
   - You may prefer [[file:texts/virtual-addressing.pdf][this 5-page introduction]]
     - It provides an alternative view on
       - Topics of Introduction and
         Main Concepts
       - Topics of section Paging
     - After working through that text, you may want to jump directly
       to the corresponding
       JiTT assignment
       to check your understanding
       - Afterwards, come back here to look at the slides, in
         particular work through section
         Uses for Virtual Memory (not covered in the text)
   - Besides, Chapter 6 of cite:Hai19 is about virtual memory
